...
function getAllDirectors(currentElement) {
  return currentElement.director;
}
const someDirector = movies.map(getAllDirectors);
console.log(someDirector);
...
function howManyMovies(currentElement) {
  if (
...
const stevenDrama = movies.filter(howManyMovies);

console.log(`são ${stevenDrama.length} filmes`);
console.log(stevenDrama);

//----------------------------------------------------------------------------------------------------------------------------------------------------->>>

// Iteration 3: All scores average - Get the average of all scores with 2 decimals

function scoresAverage(acumulador, valor) {
  const mediaScore = movies.reduce(
    (acumulador, valor) => acumulador + valor.score,
    0
  );
  let media = mediaScore / movies.length;
...
let score;
function dramaMoviesScore(currentElement) {
  if (currentElement.genre.includes('Drama')) {
    return currentElement;
  }
}
const dramaMovies = movies.filter(dramaMoviesScore);
const scoreDrama = dramaMovies.reduce(
  (acumulador, valor) => acumulador + valor.score,
  0
);
const mediaScoreDrama = scoreDrama / dramaMovies.length;
console.log(parseFloat(mediaScoreDrama.toFixed(2)));
//console.log(dramaMovies);
//console.log(scoreDrama);
...
//movies.sort(function orderByYear (a, b) {
...
let ordenedMovies = movies.sort(orderAlphabetically);

console.log(ordenedMovies.slice(0, 20));
